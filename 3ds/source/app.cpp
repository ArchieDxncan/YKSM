...
namespace
{
    ...
    [[maybe_unused]] bool update(std::string execPath)
    {
        u32 status;
...
Result App::init(const std::string& execPath)
{
    ...
    // PKSM's updater installs PKSM release artifacts. This derivative must
    // never replace itself with an upstream PKSM binary.
